...
decane_insertation_antibox = Box(
    center=[WIDTH_X * (1 - frac / 2), WIDTH_Y / 2, HEIGHT + H / 2],
    borders=[WIDTH_X * (1 - frac), WIDTH_Y, H - 2 * args.offset],
)
...
water_insertation_box = AntiBox(
    box_center=[WIDTH_X * (1 - frac / 2), WIDTH_Y / 2, HEIGHT + H / 2],
    box_borders=[WIDTH_X * (1 - frac), WIDTH_Y, H - 2 * args.offset],
    center=[WIDTH_X / 2, WIDTH_Y / 2, HEIGHT + H / 2],
    borders=[WIDTH_X, WIDTH_Y, H],
)


insert_shapes = [decane_insertation_antibox, water_insertation_box]
...
print(f"Sending files to the {server_name}")
